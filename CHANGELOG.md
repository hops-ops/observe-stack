...
* feat(deps): update crossplane-contrib/function-auto-ready docker tag to v0.6.4 (#10) (by @renovate[bot])

  Co-authored-by: renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>


See full diff: [v0.9.0...v0.10.0](https://github.com/hops-ops/observe-stack/compare/v0.9.0...v0.10.0)
